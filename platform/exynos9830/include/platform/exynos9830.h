...
#define EXYNOS9830_WDT_MASK_RESET_BIT			(23)
#define EXYNOS9830_WDT_FREQ				(25600000)
#define EXYNOS9830_WDT_INIT_PRESCALER			(128)
#define EXYNOS9830_WDT_BASE				0x10050000
#define EXYNOS9830_WDT_WTCON				(EXYNOS9830_WDT_BASE + 0x0000)
#define EXYNOS9830_WDT_WTDAT				(EXYNOS9830_WDT_BASE + 0x0004)
#define EXYNOS9830_WDT_WTCNT				(EXYNOS9830_WDT_BASE + 0x0008)
#define EXYNOS9830_WDT_WTCLRINT				(EXYNOS9830_WDT_BASE + 0x000C)
#define EXYNOS9830_WDT_PRESCALE(x)				((x) << 8)
#define EXYNOS9830_WDT_PRESCALE_MASK			(0xff << 8)

#define EXYNOS9830_WDT_WTCON_RSTEN				(1 << 0)
#define EXYNOS9830_WDT_WTCON_INTEN				(1 << 2)
#define EXYNOS9830_WDT_WTCON_ENABLE			(1 << 5)

#define EXYNOS9830_WDT_WTCON_DIV16				(0 << 3)
#define EXYNOS9830_WDT_WTCON_DIV32				(1 << 3)
#define EXYNOS9830_WDT_WTCON_DIV64				(2 << 3)
#define EXYNOS9830_WDT_WTCON_DIV128			(3 << 3)
...
#define EXYNOS9830_POWER_DREX_CALIBRATION7		(EXYNOS9830_POWER_BASE + 0x09BC)
#define EXYNOS9830_CLUSTER0_NONCPU_OUT			(EXYNOS9830_POWER_BASE + 0x1220)
#define EXYNOS9830_CLUSTER0_NONCPU_INT_EN		(EXYNOS9830_POWER_BASE + 0x1244)
#define EXYNOS9830_nWDTRESET_EN				(1 << 2)
#define EXYNOS9830_EDPCSR_DUMP_EN			(1 << 0)
#define EXYNOS9830_SWRESET_SYSTEM_TRIGGER		(1 << 1)
